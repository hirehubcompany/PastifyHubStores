...
class _LoginPageState extends State<LoginPage> {
  ...
  // New: Avatar image control
  String _currentImage = 'assets/images/1.jpg';
  ...
  void initState() {
    ...
    // Detect when email field is tapped
    _emailFocusNode.addListener(() {
      if (_emailFocusNode.hasFocus) {
        setState(() {
          _currentImage = 'assets/images/2.jpg';
          _isFirstImage = true;
        });
      }
    });
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        setState(() {
                          if (_isFirstImage) {
                            _currentImage = 'assets/images/1.jpg';
                          } else {
                            _currentImage = 'assets/images/2.jpg';
                          }
